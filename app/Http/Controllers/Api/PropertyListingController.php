...
class PropertyListingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $listings = PropertyListing::with('user')->where('user_id', '!=', $user->id)
            ->latest()
            ->paginate($perPage);
    ...
    public function store(Request $request)
    {
        ...
        // Send push notifications to users who might be interested in this property
        NotificationService::sendPropertyListingNotification($listing, $user);
